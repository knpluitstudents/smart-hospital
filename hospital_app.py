...
cols_to_scale= bundle['col_to_scale']
...
DEPT_INFO = {
    'Respiratory Medicine' : {
        'icon':'','color': '#0284c7', 'bg':'#e0f2e', 'border' : '#7dd3fc',
        'desc': 'Specialises in conditions affectioning the lungs and airways',
